...
// WE Can create a function which can deal with both LIGHT AND DARK
const toggleView = function(isDark){
...
//   //We can also change the replace with add and remove class 
